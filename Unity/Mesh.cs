...
public class Mesh : MonoBehaviour {
	...
	public bool readMesh(NetworkStream netstr) {  
		...
		//Nom du mesh
		System.IO.File.WriteAllText (@".\Ressource\"+nom, "o" + nom + "\n\n");
		...
		for (int i = 0; i <nbSommet; i++) {
			...
			System.IO.File.AppendAllText (@".\Ressource\"+nom, "v ");
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("x") + " ");	
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("y") + " ");		
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("z") + " ");		
			System.IO.File.AppendAllText (@".\Ressource\"+nom, "\n");
		}		
		System.IO.File.AppendAllText (@".\Ressource\"+nom, "\n");
		...
		for (int i = 0; i <nbTextures; i++) {
			//Debug.Log (i+1 + "eme point");
			System.IO.File.AppendAllText (@".\Ressource\"+nom, "vt ");
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("x") + " ");	
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("y") + " ");	
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("z") + " ");			
			System.IO.File.AppendAllText (@".\Ressource\"+nom, "\n");
		...
		for (int i = 0; i <nbnormales; i++) {
			//Debug.Log (i+1 + "eme point");
			System.IO.File.AppendAllText (@".\Ressource\"+nom, "vn ");
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("x") + " ");	
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("y") + " ");		
			System.IO.File.AppendAllText (@".\Ressource\"+nom, read4bytesToFloat ("z") + " ");		
			System.IO.File.AppendAllText (@".\Ressource\"+nom, "\n");
		...
		for(int i=0;i<nbTriangles; i++){
			...
			if(hasNormals && hasTexcoords){
				System.IO.File.AppendAllText (@".\Ressource\"+nom, "f "+tab[0]+"/"+tab2[0]+"/"+tab3[0]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[1]+"/"+tab2[1]+"/"+tab3[1]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[2]+"/"+tab2[2]+"/"+tab3[2]+" \n");
			}if(!hasNormals && hasTexcoords){
				System.IO.File.AppendAllText (@".\Ressource\"+nom, "f "+tab[0]+"/"+tab3[0]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[1]+"/"+tab3[1]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[2]+"/"+tab3[2]+" \n");
			}if(hasNormals && !hasTexcoords){
				System.IO.File.AppendAllText (@".\Ressource\"+nom, "f "+tab[0]+"//"+tab2[0]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[1]+"//"+tab2[1]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[2]+"//"+tab2[2]+" \n");
			}if(!hasNormals && !hasTexcoords){
				System.IO.File.AppendAllText (@".\Ressource\"+nom, "f "+tab[0]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[1]+" ");
				System.IO.File.AppendAllText (@".\Ressource\"+nom, tab[2]+" \n");
			}
		}
		System.IO.File.AppendAllText (@".\Ressource\"+nom, "\n");
